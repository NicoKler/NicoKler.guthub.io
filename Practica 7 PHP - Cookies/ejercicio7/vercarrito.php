    ...
    if($carro){
        ...
        <form name="a<?php echo $v['identificador'] ?>" method="post" action="agregacar.php?<?php echo SID ?>" id="a<?php echo $v['identificador'] ?>">
            <tr bgcolor="<?php echo $color[$contador%2]; ?>" class='prod'>
                ...
                <input name="id" type="hidden" id="id" value="<?php echo $v['idCatalogo'] ?>"> </td>
                <td align="center"><a href="borracar.php?<?php echo SID ?>&id=<?php echo $v['idCatalogo']
        ...
        <?php }?>
            ...
            <div align="center"><span class="prod">Continuar la selección de productos</span>
                ...
                <a href="repago.php?<?php echo SID;?>&costo=<?php echo $suma; ?>"><img
